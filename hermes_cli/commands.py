...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("holographic-memory", "Inspect holographic memory (tree / list / probe / search / clean)",
               "Tools & Skills",
               aliases=("holographic-mem",),
               args_hint="[tree|list <N>|probe <entity>|search <query>|clean]",
               subcommands=("tree", "list", "probe", "search", "clean")),
